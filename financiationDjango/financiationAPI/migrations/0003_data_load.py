...
class Migration(migrations.Migration):
    operations = [
        ...
        migrations.RunSQL(
            "INSERT INTO \"financiationAPI_ministrydepartment\" (name, description)"
        ...
        migrations.RunSQL(
            "INSERT INTO \"financiationAPI_faq\" (name, ministry_department_id)"
        ...
        migrations.RunSQL(
            "INSERT INTO \"financiationAPI_mayor\" (first_name, last_name)"
            "VALUES ('Martin', 'Llaryora'),"
            "('Horacio', 'Larreta'),"
            "('Juan', 'Schiaretti'),"
            "('Eleanor', 'Windsor'),"
            "('Maxwell', 'Evergreen'),"
        ...
        migrations.RunSQL(
            "INSERT INTO \"financiationAPI_visit\" (visit_date, start_time, finish_time, flyer, rent_observations, distance,"
            "travel_time, civil_registration, place_name, accommodation, modernization_fund,"
            "address_id, contacted_referrer_id, group_id, location_id, mayor_id,"
            "politic_party_id, visit_status_id)"
            ...
            "politic_party_id,"
            "visit_status_id "
            "FROM (SELECT current_date + interval '1 hour' * (row_number()"
            "over (order by A.id, CF.id, G.id, L.id, M.id, PP.id, VS.id) /"
            ...
            "AND mod(G.id, 8) = mod(L.id, 8)"
            "AND mod(L.id, 3) = mod(M.id, 3)"
