        ...
        <Container fluid className="general" id="RegistroVisita">
            ...
            <Container id="Rowcontent">
                ...
                <Container>
                    <Row >
                        <Col>
                            <Form.Control id="inputt" type="date" className="col-12" name="dob" placeholder="Fecha Visita" />
                        </Col>
                        <Col>
                ...
                <Container>
                    <Row >
                        <Col>
                            <Form.Control id="inputt" className="col-12" as="select"><option value="">Lugar</option>{lugar.map((lugar, index) =>
                                (<option key={index} value={lugar}>{lugar}</option>))}</Form.Control>
                        </Col>
                        <Col>
                            <Form.Control id="inputt" className="col-12" as="select"><option value="">Localidad</option>{localidades.map((localidad, index) =>
                                (<option key={index} value={localidad}>{localidad}</option>))}</Form.Control>
                        </Col>
                        <Col>
                            <Form.Control id="inputt" className="col-12" as="select"><option value="">Grupo</option>{grupo.map((grupo, index) =>
                ...
                <Container>
                    <Row>
                        <Col>
                            <Form.Control id="inputt" className="col-12" as="select"><option value="">Visit Status</option>{visitstatus.map((visitstatus, index) =>
                                (<option key={index} value={visitstatus}>{visitstatus}</option>))}</Form.Control>
                        </Col>
                        <Col>
                            <Form.Control id="inputt" className="col-12" as="select"><option value="">Agreement</option>{agreement.map((agreement, index) =>
                                (<option key={index} value={agreement}>{agreement}</option>))}</Form.Control>
                        </Col>
                        <Col>
                            <Form.Control id="inputt" className="col-12" as="select"><option value="">Contacto Referente</option>{contactedreferrer.map((contactedreferrer, index) =>
                ...
                <Container>
                    <Row>
                        <Col>
                            <Form.Control id="inputt" className="col-12" as="select"><option value="">Address</option>{address.map((address, index) =>
                                (<option key={index} value={address}>{address}</option>))}</Form.Control>
                        </Col>
                        <Col>
                            <Form.Control id="inputt" className="col-12" as="select"><option value="">Logo</option>{logo.map((logo, index) =>
