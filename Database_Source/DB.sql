...
(
    ...
    CUIL                      BIGINT,
    CONTRASEÑA                MEDIUMBLOB,
    FOTO_DE_PERFIL            LONGBLOB,
    ID_EMAIL                  INT,
    ID_ROL                    INT,
    ID_ESTADO_DE_VERIFICACION INT,
    ID_ESTADO_DE_USUARIO      INT,
    CONSTRAINT `USUARIO->EMAIL_USUARIO` FOREIGN KEY (ID_EMAIL) REFERENCES EMAILS_USUARIOS (ID),
...
(
    ...
    ID_EMAIL    INT,
    ID_TELEFONO INT,
    CONSTRAINT `REFERENTE_CONTACTADO->EMAIL_REFERENTE_CONTACTADO` FOREIGN KEY (ID_EMAIL) REFERENCES EMAILS_REFERENTES_CONTACTADOS (ID),
    CONSTRAINT `REFERENTE_CONTACTADO->TELEFONO_REFERENTE_CONTACTADO` FOREIGN KEY (ID_TELEFONO) REFERENCES TELEFONOS_REFERENTES_CONTACTADOS (ID)
);
...
(
    ...
    ID_COORDINADOR INT,
    ID_ASESOR      INT,
    CONSTRAINT `GRUPO->USUARIO` FOREIGN KEY (ID_COORDINADOR) REFERENCES USUARIOS (ID)
);
